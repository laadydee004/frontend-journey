...
function displayStory(genre){
    const selectStory = storyObj[genre];
    if(selectStory){
        resultParagraph.textContent = selectStory.story;
        maincontent.style.borderColor = selectStory.borderColor;
        borderContainer.style.borderColor = selectStory.borderColor;
    }
}
